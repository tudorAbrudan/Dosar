...
certificat_nastere: Certificat emis de Starea Civilă (Consiliul Local / Direcția de Evidență a Persoanelor). EXISTĂ DOUĂ VARIANTE comune: (a) MODERN, post-1989, antet „ROMÂNIA / CONSILIUL LOCAL / Direcția de Evidență a Persoanelor"; (b) VECHE, era comunistă, antet „REPUBLICA SOCIALISTĂ ROMÂNIA / CONSILIUL POPULAR / COMITETUL EXECUTIV". Tratează identic — ambele sunt certificate de naștere valide. Document permanent (NU expiră). Câmpurile sunt completate de mână în varianta veche (deseori pe formular tipărit cu subliniere), iar în varianta modernă sunt deja preprintate.
  - subject_name="ABRUDAN TUDOR-VASILE" — numele complet al persoanei (al cărei certificat este). Combină câmpurile „Numele de familie" + „Prenumele" (sau singurul câmp „Nume" în modern). Litere mari, păstrează cratimele („TUDOR-VASILE").
  - cnp="1840401125909" — Codul Numeric Personal, 13 cifre exact (sau 11 pe variantele pre-1979). Sub labelul „CODUL NUMERIC PERSONAL" / „CNP". Doar cifre — fără spații, fără separatoare. Confuzii uzuale OCR: 0↔O, 1↔I, 8↔3. Cifrele apar în casete sub câmp tipărit „S AA LL ZZ NNN C" (poziții fixe).
  - father_name="ABRUDAN VASILE" — numele tatălui. Combină „Numele de familie al tatălui" + „Prenumele tatălui" (variantă veche), SAU câmpul single „Tatăl" (variantă modernă). Apare în secțiunea „PĂRINȚII", de obicei coloana dreaptă.
  - mother_name="ABRUDAN MARIOARA" — numele mamei. Combină „Numele de familie al mamei" + „Prenumele mamei", SAU „Mama". Apare sub tată în secțiunea „PĂRINȚII".
  - birth_date="01.04.1984" — data nașterii. În varianta VECHE apare în 3 câmpuri SEPARATE: „Anul" (cifre + litere, ex „1984 nouă sute optzeci și patru" → folosește 1984), „Luna" (ex „aprilie" → 04), „Ziua" (ex „1 unu" → 01). Combină-le ca ZZ.LL.AAAA. În varianta MODERNĂ apare ca dată completă într-un singur câmp.
  - birth_place="Cluj-Napoca, Cluj" — locul nașterii copilului. Combină „Comuna/Orașul/Municipiul" și „Județul" sub label-ul „LOCUL NAȘTERII COPILULUI" (NU confunda cu „LOCUL ÎNREGISTRĂRII" care apare separat, pe partea dreaptă). Format „Localitate, Județ".
  - registration_number="4514/1984" — nr. înregistrării în registrul stării civile. Apare după „Nașterea a fost trecută în registrul stării civile la nr. ... din anul ... luna ... ziua ...". Format „nr/an".
  - series_number="N.C. 609828" — Seria + numărul certificatului propriu. Apare la final, „Seria N.C. nr. ...". Păstrează prefixul seriei (N.C., A.B., B.C. etc.) și numărul.
  - issueDate — data eliberării certificatului (după „Eliberat astăzi" sau „eliberat la"). Format YYYY-MM-DD în câmpul issueDate, NU în fields. DIFERIT de birth_date — birth_date e data evenimentului, issueDate e data emiterii hârtiei.
certificat_botez: Certificat emis de o parohie ortodoxă/catolică/etc. ce atestă săvârșirea Tainei Botezului. Formularul tipărit are spații completate de mână cu nume și date (frecvent ilegibile parțial — concentrează-te pe text near printed labels). Document permanent (NU expiră). Câmpurile completate de mână pot avea ortografie variată (cratime, diacritice, prescurtări). REGULĂ CHEIE: certificatul de BOTEZ menționează și un nr. de certificat de NAȘTERE — acea referință NU îl face certificat de naștere. Decisiv: emisă de biserică (parohie/arhiepiscopie), nu de Starea Civilă.
  ...
  - father_name="ABRUDAN VASILE" — numele tatălui copilului. Apare imediat după „a(l) d-lui" (părintele bărbat). Litere mari, păstrează cratimele și inițialele.
  - mother_name="ABRUDAN MARIANA" — numele mamei copilului. Apare după „și a(l) d-nei" pe rândul următor. Litere mari.
  - birth_date="01.04.1984" — data NAȘTERII copilului (eveniment biologic). Apare după „fiind născut(ă) în ziua de". Format ZZ.LL.AAAA. DIFERIT de baptism_date.
  - document_number="104/2016" — numărul propriu al certificatului de botez (NU al certificatului de naștere referit). Apare după „Nr." pe ultimul rând, înainte sau lângă semnătura preotului. Format „nr/an".
  - priest_name="Dumitru-Marcel Andreșa" — numele preotului paroh care a emis certificatul. Apare deasupra/lângă „PAROH" sau „preot paroh", de obicei dactilografiat. Poate include „Pr." / „Pr. Dr." ca prefix — păstrează-l.
  - issueDate — data eliberării certificatului (după „Drept care s-a eliberat acest certificat astăzi"), NU data botezului, NU data nașterii. Format YYYY-MM-DD în câmpul issueDate, nu în fields.
