...
const ENTRIES = {
  services: {
    ...
    medicalChat: { required: true, keywords: ['chat medical', 'asistent'] },
    medicalExtractor: { required: true, keywords: ['extracție', 'observații'] },
    medicalObservations: { required: true, keywords: ['observații'] },
    medicalRecord: { required: true, keywords: ['dosar medical'] },
  ...
  screens: {
    ...
    'entitati/medical/index': { required: true, keywords: ['dosar medical', 'Dosare medicale'] },
    'entitati/medical/[id]/index': { required: true, keywords: ['dosar medical', 'Timeline'] },
    'entitati/medical/[id]/review': { required: true, keywords: ['needs_review', 'verifică observații'] },
